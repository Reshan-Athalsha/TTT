...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; }
        ...
        .btn-ttt { background: linear-gradient(135deg, #1a1a2e, #16213e); color: #f0c040; border: none; border-radius: 10px; padding: 13px; font-weight: 700; width: 100%; font-size: 1rem; }
        .btn-ttt:hover { opacity: 0.9; color: #f0c040; }
            ...
            <div class="auth-card">
                ...
                <div class="auth-body">
                    ...
                    <% if (request.getParameter("deleted") != null) { %>
                        <div class="alert alert-warning mb-3"><i class="bi bi-info-circle me-2"></i>Your account has been deleted.</div>
                    <% } %>
                    <form action="/register" method="POST">
                        <div class="mb-3">
                            <label class="form-label">Full Name</label>
                            <div class="icon-wrap"><i class="bi bi-person"></i>
                        ...
                        <button type="submit" class="btn-ttt"><i class="bi bi-person-plus me-2"></i>Create Account</button>
                    </form>
                    <hr class="my-4">
                    <p class="text-center text-muted mb-0" style="font-size:0.9rem">Already have an account? <a href="/login" style="color:#1a1a2e;font-weight:700;">Sign in</a></p>
                </div>
            </div>
